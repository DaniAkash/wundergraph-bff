...
import type {
	DragonsResponse,
	DragonsResponseData,
	LaunchPadsWithWeatherResponse,
	LaunchPadsWithWeatherResponseData,
	UsersGetResponse,
	UsersGetInput,
...
export type Queries = {
	...
	launchPadsWithWeather: {
		input?: undefined;
		response: { data?: LaunchPadsWithWeatherResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
		liveQuery: boolean;
	};
	"users/get": {
